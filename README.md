...
For Codex authentication, AgentBox publishes `127.0.0.1:1455` to the Codex container so OAuth callbacks to `http://localhost:1455/auth/callback` can complete.
